...
<html>
    ...
    <body>
        ...
        if (empty($vehicleNo) ||empty($crime) || empty($place) || empty($date) || empty($name) || empty($mobile)) {
            ...
            $sql = "INSERT INTO CRIME(VECHICLENO,CRIMEDONE, PLACE, DATE, PROOF, NAME, MOB) VALUES ('$vehicleNo',' $crime','$place', '$date', '$proof', '$name', '$mobile')";
    ...
    ?>
        <div id="outer">
            ...
            <div id="title">
                ...
                <h3 id="titlecitizen">Report Crime</h3>
            </div>
        ...
        <input type="submit" value="Submit" style="margin-left:2cm">
            ...
            <div id="footer">
                <div id="f1">
                    ...
                    <hr>
                    <p id="para">The Motor Vehicles Department is regulated by the Government of Kerala in terms of policy formulation and its implementation.  The Department is administered by the Transport Commissioner who is the Head of Department.</p>
